...
- verify_worktrees should stay on a bounded argument contract instead of widening into free-form provider args
...
- The first promoted official registry boundary keeps that extracted view indexing-backed with no separate persistence layer
