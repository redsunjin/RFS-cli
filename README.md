...
- [Agent skill registry surface](./docs/agent-skill-registry-surface.md)
...
- project statistics
- agent-safe file listing, text search, note listing, and note inspection
...
uv run rfs agent show-note <document-id> --format json
